...
void setup() {
  ...
  pinMode(33,OUTPUT);//indicates interpolation task is running
  blink_work();
  init_mutexes();
...
// void setup() {
//     Serial.begin(921600); // Keep high baud rate
//     Serial.println("Starting JPEG Serial Streamer...");
